...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> handleNotFoundException(NotFoundException e, HttpServletRequest request) {
    ...
    public ResponseEntity<CustomError> handleBookNotAvailableException(BookNotAvailableException e, HttpServletRequest request) {
    ...
    public ResponseEntity<CustomError> handleDepositException(DepositException e, HttpServletRequest request) {
        HttpStatus status = HttpStatus.BAD_REQUEST;
        CustomError err = new CustomError(Instant.now(), status.value(), e.getMessage(), request.getRequestURI());
        return ResponseEntity.status(status).body(err);
    }
